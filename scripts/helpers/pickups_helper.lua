...
---@return integer
---@function
function OxyTheBunny:GetFreeOptionsPickupIndex(startIndex)
...
---@function
function OxyTheBunny:AwardPedestalItem(pickup, player)
...
---@return boolean
function OxyTheBunny:IsBlindPedestal(pedestal)
...
---@param pickup EntityPickup
function OxyTheBunny:IsDevilDealItem(pickup)
...
function OxyTheBunny:FindClosestPedestal(Position, OnlyFree)
