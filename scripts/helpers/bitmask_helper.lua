...
---@return TearFlags
---@function
function OxyTheBunny:TearFlag(bitmaskOffset)
...
---@return string[]
function OxyTheBunny:GetNamesInBitmask(flagTable, bitmask, maxInt)
	local names = {}
	local inv = OxyTheBunny:Invert(flagTable)
	for i = 0, maxInt do
...
function OxyTheBunny:HasBitFlags(flags, checkFlag)
...
---@param flags flag
---@param checkFlag flag
function OxyTheBunny:HasAnyBitFlags(flags, checkFlag)
...
---@param addFlag flag
---@return flag
function OxyTheBunny:AddBitFlags(flags, addFlag)
	flags = flags | addFlag
	return flags
end
...
---@return flag
function OxyTheBunny:RemoveBitFlags(flags, removeFlag)
