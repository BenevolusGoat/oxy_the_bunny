...
local function applyMyosotis(_, npc, pos, tearFlags, source, damage, player)
...
Mod:AddCallback(Mod.ModCallbacks.CHAINSAW_APPLY_TEARFLAG_EFFECTS, applyMyosotis, TearFlags.TEAR_SPORE)