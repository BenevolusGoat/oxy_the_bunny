...
---@function
function OxyTheBunny:KillPedestal(pedestal)
...
---@function
function OxyTheBunny:KillChoice(pickup)
...
---@function
function OxyTheBunny:PricedPickup(player, pickup)
...
function OxyTheBunny:PickupShopKill(player, pickup, sound)
...
---@function
---@param pickup EntityPickup
function OxyTheBunny:PickupKill(pickup)
	pickup:PlayPickupSound()
...
---@function
function OxyTheBunny:CollectCustomCoin(pickup, SoundID)
...
---@param pickup EntityPickup
---@function
function OxyTheBunny:PayPickupPrice(player, pickup)
...
function OxyTheBunny:KillDevilPedestals(ignoredPickup, filter)
...
function OxyTheBunny:BruteForceRoll(itemPoolType, maxIterations, filter)
...
function OxyTheBunny:MakePedestalEmpty(pedestal)
	if REPENTOGON then
